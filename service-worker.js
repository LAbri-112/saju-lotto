const CACHE_NAME = "saju-lotto-v67";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=feedback-v62",
  "./app.js?v=feedback-v62",
  "./manifest.webmanifest",
  "./assets/icon.svg",
  "./data/lotto-results.js?v=feedback-v62",
  "./data/pension-results.js?v=feedback-v62"
];
