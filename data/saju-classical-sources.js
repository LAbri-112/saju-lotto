window.SAJU_CLASSICAL_SOURCES = {
  ...
  "license": {
    ...
    "allowedUse": ["source_registry", "rule_reference", "documentation"],
  ...
  "sources": [
    ...
    },
    {
      ...
      "license": {
        ...
        "source": "data.go.kr",
        "allowedUse": ["calendar_validation", "solar_terms"],
    ...
    },
    {
      ...
      "license": {
        ...
        "source": "arxiv",
        "allowedUse": ["readme_reference", "method_review"],
